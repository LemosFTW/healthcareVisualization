"""Tests for Story 1.3: Hl7V2Decoder."""
import pytest
...
# Minimal valid HL7 v2.3 message (raw strings avoid escape-sequence SyntaxWarning for \&)
VALID_HL7 = (
...
def _make_raw(payload: str, protocol: str = "hl7v2") -> RawMessage:
...
def test_decode_handles_lf_line_endings():
    """Decoder must handle \n-separated segments in addition to \r."""
